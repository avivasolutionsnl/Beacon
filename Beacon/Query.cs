...
namespace Beacon
{
    public class Query : DynamicObject, IEnumerable
    {
        ...
        private bool TryFind(string bindingName, out object result)
        {
            ...
            if (selectedDecendants != null)
            {
                if (selectedDecendants.Count() == 1 &&
                    ...
                    bindingName.Equals(selectedDecendants.First().Name.LocalName,
        ...
        private bool TryFind(string bindingName, XDocument parentDocument, out string value,
            out IEnumerable<XElement> selectedDecendants)
        {
        ...
        private static bool TryFindDecendants(string name, XDocument doc, out IEnumerable<XElement> selectedDecendants)
        {
        ...
        private static bool TryFindAttributeValueByName(string name, XElement element, out string selectedAttributeValue)
        {
